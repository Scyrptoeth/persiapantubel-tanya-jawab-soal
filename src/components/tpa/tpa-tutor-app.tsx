...
import { LogoTPA } from "@/components/shared/Logos";
    ...
    <main className="min-h-dvh bg-paper text-[#17201c] lg:h-dvh lg:overflow-hidden">
      <div className="mx-auto flex min-h-dvh w-full max-w-none flex-col px-4 py-3 sm:px-6 lg:h-dvh lg:min-h-0 lg:py-4">
        <Header 
          ...
          logo={<LogoTPA className="scale-75" />}
        />
          ...
          <section className="flex min-h-[720px] flex-col rounded-2xl border border-forest/10 bg-white shadow-premium lg:min-h-0 lg:overflow-auto 2xl:overflow-hidden">
            ...
            <div className="grid shrink-0 gap-3 p-3 md:grid-cols-[220px_minmax(260px,1fr)] 2xl:grid-cols-[220px_minmax(260px,0.7fr)_minmax(360px,1fr)]">
              <label className="grid gap-1 text-sm font-bold text-forest">
                ...
                <select
                  value={domain}
                  onChange={(e) => setDomain(e.target.value as TpaDomain)}
              ...
              <AnimatePresence>
                {error && (
                  <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex gap-2 rounded-xl border border-red-100 bg-red-50 p-3 text-sm text-red-800 md:col-span-2 2xl:col-span-1">
